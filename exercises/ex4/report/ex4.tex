...
by the Reduce function is more efficient than plain speeding up summing.
...
is no significant speed-up to be gained in the range specified in the problem
set (with $\{k \in \mathbb{N} : k \in [3, 14]\}$) due to the computation
completing to quickly, or the overhead of initialization and printing of results
