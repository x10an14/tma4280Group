...
To somewhat make up for this lack, some data was run on a local machine; a laptop with Ubuntu. This machine, however, only had 2 physical cores, which hampered the testing a lot.
Refer to image added with delivery for more info, as there was no more time before the deadline.
